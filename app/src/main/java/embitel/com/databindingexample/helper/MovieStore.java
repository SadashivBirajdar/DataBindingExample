...
public class MovieStore {
    ...
    static {
        ...
        ALL_MOVIES.add(new Movie().setTitle("Marvel's The Avengers 2: Age of Ultron").setGenre("Action")
        ...
        ALL_MOVIES.add(new Movie().setTitle("Shaun the Sheep Movie").setGenre("Family")
                ...
                .setImageUrl("https://image.tmdb.org/t/p/original/ibfQa5xTUKHfKbVQIIgu9mDjgkS_dummy.jpg"));
    }
